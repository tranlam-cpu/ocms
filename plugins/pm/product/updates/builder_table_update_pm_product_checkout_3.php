...
class BuilderTableUpdatePmProductCheckout3 extends Migration
{
    public function up()
    {
        Schema::table('pm_product_checkout', function($table)
        {
            $table->string('product_name', 65535)->nullable(false)->unsigned(false)->default(null)->comment(null)->change();
        });
    }
